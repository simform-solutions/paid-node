...
Transaction = _.extend(Transaction, {
  ...
  delete: function(id, params, headers, callback) {
    var methodArgs = APIResource.prepareArguments(arguments, Transaction.delete);
    return new APIMethod("delete", "/transactions/:id", methodArgs, undefined, APIResource.constructBldr(Transaction)).execute();
  },
  ...
  createRefund: function(id, params, headers, callback) {
    var methodArgs = APIResource.prepareArguments(arguments, Transaction.createRefund);
    return new APIMethod("post", "/transactions/:id/refunds", methodArgs, undefined, APIResource.constructBldr(Transaction)).execute();
  }
...
Transaction.prototype = {
  ...
  delete: function(params, headers, callback) {
    var methodArgs = APIResource.prepareArguments(arguments, Transaction.prototype.delete);
    methodArgs.params = _.extend(this, methodArgs.params);
    return new APIMethod("delete", "/transactions/:id", methodArgs, this, APIResource.constructBldr(Transaction)).execute();
  },
  ...
  createRefund: function(params, headers, callback) {
    var methodArgs = APIResource.prepareArguments(arguments, Transaction.prototype.createRefund);
    return new APIMethod("post", "/transactions/:id/refunds", methodArgs, this, APIResource.constructBldr(Transaction)).execute();
  }
