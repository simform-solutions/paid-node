...
Invoice = _.extend(Invoice, {
  ...
  void: function(id, params, headers, callback) {
    var methodArgs = APIResource.prepareArguments(arguments, Invoice.void);
    return new APIMethod("post", "/invoices/:id/void", methodArgs, undefined, APIResource.constructBldr(Invoice)).execute();
  },
...
Invoice.prototype = {
  ...
  void: function(params, headers, callback) {
    var methodArgs = APIResource.prepareArguments(arguments, Invoice.void);
    return new APIMethod("post", "/invoices/:id/void", methodArgs, this, APIResource.constructBldr(Invoice)).execute();
  },
